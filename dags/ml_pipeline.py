...
default_args = {
    ...
    'email': ['arpitha.gurumurthy@sjsu.edu'],
...
dag = DAG(
    ...
    description='A Machine Learning pipeline for driver drowsiness detection',
...
download_images = BashOperator(
    ...
    bash_command='sh /usr/local/airflow/scripts/download_images_statefarm.sh ',
    dag=dag,
)
...
serve_commands = """
    ...
    python3 /usr/local/airflow/scripts/app.py
    """
serve = BashOperator(
    task_id='serve',
    depends_on_past=False,
